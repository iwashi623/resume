...
しかしながら､この構成の問題点は､module内のコードを少しでもいじると､試したい環境以外でも､差分が生まれてしまうことになる｡例えば､DEV環境にのみなにか変更を入れて試したいとき､もれなくSTGやPROD環境でも差分が生まれてしまう｡
そうすると､誰かがインフラリソースを変更をかけているとき､他の誰かが新しいPull Requestを作ると､自分と関係のない差分が発生する｡
また､たとえばDevとSTG環境だけはIP制限をかけたいなどの独自の設定も､共通Moduleを使っているうちはいれることができない･または難しいことをしなければいけなくなる｡

このような状況ではチームのメンバーがTerrafromのコードを編集ことが難しくなり､結果としてインフラリソースの作成や更新が他人事になってしまうと考えた｡
しかしながら､チームのモチベーションとしてチームのメンバーが一気通貫した開発ができる状況のほうが望ましい状況であった｡そのため､この問題を解消した｡
